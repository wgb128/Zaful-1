...
@interface MyOrderDetailAddressCell ()
...
+ (MyOrderDetailAddressCell *)cellWithTableView:(UITableView *)tableView andIndexPath:(NSIndexPath *)indexPath {
    //注册cell
    [tableView registerClass:[MyOrderDetailAddressCell class] forCellReuseIdentifier:MY_ORDERS_DETAIL_ADDRESS_INENTIFIER];
    return [tableView dequeueReusableCellWithIdentifier:MY_ORDERS_DETAIL_ADDRESS_INENTIFIER forIndexPath:indexPath];
}
...
-(void)setOrderModel:(MyOrderDetailOrderModel *)orderModel{
    ...
    self.addressUserTel.text = orderModel.tel;
