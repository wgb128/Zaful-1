...
@interface MyOrderDetailOrderCell ()
...
@implementation MyOrderDetailOrderCell

+ (MyOrderDetailOrderCell *)cellWithTableView:(UITableView *)tableView andIndexPath:(NSIndexPath *)indexPath {
    [tableView registerClass:[MyOrderDetailOrderCell class] forCellReuseIdentifier:MY_ORDERS_DETAIL_ORDER_INENTIFIER];
    return [tableView dequeueReusableCellWithIdentifier:MY_ORDERS_DETAIL_ORDER_INENTIFIER forIndexPath:indexPath];
}
