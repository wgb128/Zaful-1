...
@interface CartInfoNoPaymentCell ()
@property (nonatomic, strong) YYAnimatedImageView *warnIcon;
@property (nonatomic, strong) UILabel *tipLabel;
@end

@implementation CartInfoNoPaymentCell

+ (CartInfoNoPaymentCell *)noPaymentCellWithTableView:(UITableView *)tableView indexPath:(NSIndexPath *)indexPath {
    //注册cell
    [tableView registerClass:[CartInfoNoPaymentCell class] forCellReuseIdentifier:NSStringFromClass([self class])];
