...
-(void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (self.navigationOperation == UINavigationControllerOperationPush) {
        ...
        nextVC.layer.shadowOpacity = 0;
        
        self.navigationController.view.transform = [self.localeLanguageCode hasPrefix:@"ar"] ? CGAffineTransformMakeTranslation(-ScreenWidth, 0) :  CGAffineTransformMakeTranslation(ScreenWidth, 0);
        
        [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
            //toView.frame = toViewEndFrame;
            self.navigationController.view.transform = CGAffineTransformMakeTranslation(0, 0);
            screentImgView.center = [self.localeLanguageCode hasPrefix:@"ar"] ? CGPointMake(ScreenWidth, ScreenHeight / 2) : CGPointMake(-ScreenWidth/2, ScreenHeight / 2);
    ...
    if (self.navigationOperation == UINavigationControllerOperationPop) {
        ...
        UIImageView * lastVcImgView = [[UIImageView alloc]init];
        lastVcImgView.frame = [self.localeLanguageCode hasPrefix:@"ar"] ? CGRectMake(ScreenWidth , 0, ScreenWidth, ScreenHeight) : CGRectMake(-ScreenWidth , 0, ScreenWidth, ScreenHeight);
        ...
        screentImgView.layer.shadowOpacity = 0;
//
        ...
        [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
            ...
            screentImgView.center = [self.localeLanguageCode hasPrefix:@"ar"] ? CGPointMake(-ScreenWidth / 2 , ScreenHeight / 2) :  CGPointMake(ScreenWidth * 3 / 2 , ScreenHeight / 2);
