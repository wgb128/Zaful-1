...
- (void)initialiseControl {
    ...
    self.leftHandle.cornerRadius = HANDLE_DIAMETER / 2;
    ...
    self.minLabel.frame = CGRectMake(0, 0, 75, 16);
    ...
    self.maxLabel.frame = CGRectMake(0, 0, 75, 16);
...
- (void)layoutSubviews {
    ...
    float barSidePadding = 26.0f;
    CGRect currentFrame = self.frame;
    float yMiddle = currentFrame.size.height/2.0 + 10;
    CGPoint lineLeftSide = CGPointMake(barSidePadding, yMiddle);
    CGPoint lineRightSide = CGPointMake(currentFrame.size.width-barSidePadding*2, yMiddle);
    self.sliderLine.frame = CGRectMake(lineLeftSide.x, lineLeftSide.y, currentFrame.size.width-barSidePadding*2, 2);
...
//    self.maxLabel.string = [formatter stringFromNumber:@(self.selectedMaximum)];
    ...
    self.minLabel.string = [ExchangeManager transforPrice:[NSString stringWithFormat:@"%f",ceilf(self.selectedMinimum)]];
    self.maxLabel.string = [ExchangeManager transforPrice:[NSString stringWithFormat:@"%f",ceilf(self.selectedMaximum)]];
