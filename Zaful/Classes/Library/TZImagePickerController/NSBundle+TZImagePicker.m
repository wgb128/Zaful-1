...
+ (NSString *)tz_localizedStringForKey:(NSString *)key value:(NSString *)value {
    ...
    if ([language rangeOfString:@"zh-Hans"].location != NSNotFound) {
        language = @"zh-Hans";
    } else if ([language rangeOfString:@"ar"].location != NSNotFound) {
        language = @"ar";
    } else if ([language rangeOfString:@"es"].location != NSNotFound) {
        language = @"es";
    } else if ([language rangeOfString:@"fr"].location != NSNotFound) {
        language = @"fr";
    } else {
        language = @"en";
    }
