...
- (void)configBottomToolBar {
    ...
    CGFloat previewWidth = [previewText boundingRectWithSize:CGSizeMake(CGFLOAT_MAX, CGFLOAT_MAX) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16 *DSCREEN_WIDTH_SCALE]} context:nil].size.width;
    ...
    _previewButton.titleLabel.font = [UIFont systemFontOfSize:16 *DSCREEN_WIDTH_SCALE];
    ...
    if (tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        CGFloat fullImageWidth = [fullImageText boundingRectWithSize:CGSizeMake(CGFLOAT_MAX, CGFLOAT_MAX) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:13 *DSCREEN_WIDTH_SCALE]} context:nil].size.width;
        ...
        _originalPhotoButton.titleLabel.font = [UIFont systemFontOfSize:16 *DSCREEN_WIDTH_SCALE];
        ...
        _originalPhotoLable.font = [UIFont systemFontOfSize:16 *DSCREEN_WIDTH_SCALE];
        _originalPhotoLable.textColor = [UIColor blackColor];
        if (_isSelectOriginalPhoto) [self getSelectedPhotoBytes];
    }
    
    _okButton = [UIButton buttonWithType:UIButtonTypeCustom];
    _okButton.frame = CGRectMake(self.view.tz_width - 59 *DSCREEN_WIDTH_SCALE - 12, 3, 59*DSCREEN_WIDTH_SCALE, 44);
    NSString *localeLanguageCode = [ZFLocalizationString shareLocalizable].nomarLocalizable;
    _okButton.titleLabel.font = [localeLanguageCode hasPrefix:@"fr"] || [localeLanguageCode hasPrefix:@"es"] ? [UIFont systemFontOfSize:15 *DSCREEN_WIDTH_SCALE] : [UIFont systemFontOfSize:16 *DSCREEN_WIDTH_SCALE];
//    _okButton.titleLabel.font = [UIFont systemFontOfSize:16 *DSCREEN_WIDTH_SCALE];
    ...
    _numberImageView.frame = CGRectMake(self.view.tz_width - 71 *DSCREEN_WIDTH_SCALE - 28 *DSCREEN_WIDTH_SCALE, 10, 30 *DSCREEN_WIDTH_SCALE, 30 *DSCREEN_WIDTH_SCALE);
    _numberImageView.hidden = tzImagePickerVc.selectedModels.count <= 0;
    _numberImageView.backgroundColor = [UIColor clearColor];
    
    _numberLable = [[UILabel alloc] init];
    _numberLable.frame = _numberImageView.frame;
    _numberLable.font = [UIFont systemFontOfSize:15 *DSCREEN_WIDTH_SCALE];
