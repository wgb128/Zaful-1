...
- (void)configBottomToolBar {
    ...
    if (_tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        _originalPhotoButton.titleLabel.font = [UIFont systemFontOfSize:13 *DSCREEN_WIDTH_SCALE];
        ...
        _originalPhotoLable.font = [UIFont systemFontOfSize:13 *DSCREEN_WIDTH_SCALE];
    ...
    _okButton.titleLabel.font = [localeLanguageCode hasPrefix:@"fr"] || [localeLanguageCode hasPrefix:@"es"] ? [UIFont systemFontOfSize:14 *DSCREEN_WIDTH_SCALE] : [UIFont systemFontOfSize:16 *DSCREEN_WIDTH_SCALE];
    ...
    _numberImageView.frame = CGRectMake(self.view.tz_width - 56 - 28 *DSCREEN_WIDTH_SCALE, 7, 30 *DSCREEN_WIDTH_SCALE, 30 *DSCREEN_WIDTH_SCALE);
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (_currentIndex != currentIndex) {
        if(!ISIOS9 && ![SystemConfigUtils isRightToLeftLanguage]) {
