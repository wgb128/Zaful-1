 ...
 */
- (void)yy_setImageWithURL:(nullable NSURL *)imageURL processorKey:(NSString *)processorKey placeholder:(nullable UIImage *)placeholder;
 ...
 */
- (void)yy_setImageWithURL:(nullable NSURL *)imageURL processorKey:(NSString *)processorKey options:(YYWebImageOptions)options;
...
/**
 ...
 @param placeholder The image to be set initially, until the image request finishes.
 */
- (void)yy_setHighlightedImageWithURL:(nullable NSURL *)imageURL processorKey:(NSString *)processorKey placeholder:(nullable UIImage *)placeholder;
...
/**
 ...
 @param options  The options to use when request the image.
 */
- (void)yy_setHighlightedImageWithURL:(nullable NSURL *)imageURL processorKey:(NSString *)processorKey options:(YYWebImageOptions)options;
