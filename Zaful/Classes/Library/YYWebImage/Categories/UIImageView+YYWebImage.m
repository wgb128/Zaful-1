...
- (void)setYy_imageURL:(NSURL *)imageURL {
    [self yy_setImageWithURL:imageURL
                processorKey:defaultProcessorKey
                 placeholder:nil
                     options:kNilOptions
                     manager:nil
                    progress:nil
...
- (void)setYy_imageURL:(NSURL *)imageURL processorKey:(NSString *)processorKey {
    [self yy_setImageWithURL:imageURL
...
- (void)yy_setImageWithURL:(NSURL *)imageURL processorKey:(NSString *)processorKey placeholder:(UIImage *)placeholder {
    [self yy_setImageWithURL:imageURL
                processorKey:processorKey
...
- (void)yy_setImageWithURL:(NSURL *)imageURL processorKey:(NSString *)processorKey options:(YYWebImageOptions)options {
    [self yy_setImageWithURL:imageURL
                processorKey:processorKey
                 placeholder:nil
                     options:options
...
- (void)yy_setImageWithURL:(NSURL *)imageURL
    ...
    _yy_dispatch_sync_on_main_queue(^{
        ...
        if (manager.cache &&
            ...
            imageFromMemory = [manager.cache getImageForKey:[NSString stringWithFormat:@"%@-<%@>",[manager cacheKeyForURL:imageURL],processorKey] withType:YYImageCacheTypeMemory];
        }
        if (imageFromMemory) {
        ...
        dispatch_async([_YYWebImageSetter setterQueue], ^{
            ...
            newSentinel = [setter setOperationWithSentinel:sentinel url:imageURL processorKey:processorKey options:options manager:manager progress:_progress transform:transform completion:_completion];
            weakSetter = setter;
        });
    });
}
...
- (void)setYy_highlightedImageURL:(NSURL *)imageURL processorKey:(NSString *)processorKey{
    [self yy_setHighlightedImageWithURL:imageURL
                           processorKey:processorKey
                            placeholder:nil
                                options:kNilOptions
...
- (void)yy_setHighlightedImageWithURL:(NSURL *)imageURL processorKey:(NSString *)processorKey placeholder:(UIImage *)placeholder {
    [self yy_setHighlightedImageWithURL:imageURL
                           processorKey:processorKey
                            placeholder:placeholder
                                options:kNilOptions
...
- (void)yy_setHighlightedImageWithURL:(NSURL *)imageURL processorKey:(NSString *)processorKey options:(YYWebImageOptions)options {
    [self yy_setHighlightedImageWithURL:imageURL
                           processorKey:processorKey
                            placeholder:nil
                                options:options
