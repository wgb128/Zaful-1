...
- (int32_t)setOperationWithSentinel:(int32_t)sentinel
    ...
    NSOperation *operation = [manager requestImageWithURL:imageURL processorKey:processorKey options:options progress:progress transform:transform completion:completion];
