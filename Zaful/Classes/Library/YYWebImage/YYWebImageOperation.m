...
- (instancetype)init {
    ...
    return [self initWithRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@""]] options:0 cache:nil cacheKey:nil processorKey:nil progress:nil transform:nil completion:nil];
}
...
- (instancetype)initWithRequest:(NSURLRequest *)request
    ...
    _processorKey = processorKey ? processorKey : @"";
