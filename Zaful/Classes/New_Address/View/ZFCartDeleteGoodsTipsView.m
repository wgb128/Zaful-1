...
@interface ZFCartDeleteGoodsTipsView () <ZFInitViewProtocol>
...
@implementation ZFCartDeleteGoodsTipsView
...
- (void)cancelButtonAction:(UIButton *)sender {
    if (self.cartDeleteGoodsConfirmCompletionHandler) {
        self.cartDeleteGoodsConfirmCompletionHandler(NO);
    }
}

- (void)confirmButtonAction:(UIButton *)sender {
    if (self.cartDeleteGoodsConfirmCompletionHandler) {
        self.cartDeleteGoodsConfirmCompletionHandler(YES);
    }
}
...
- (UILabel *)tipsLabel {
    if (!_tipsLabel) {
        ...
        _tipsLabel.text = ZFLocalizedString(@"CartRemoveProductTips", nil);
    }
    return _tipsLabel;
}
