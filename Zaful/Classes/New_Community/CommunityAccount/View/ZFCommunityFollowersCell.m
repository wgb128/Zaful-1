...
@interface ZFCommunityFollowersCell () <ZFInitViewProtocol>
...
@implementation ZFCommunityFollowersCell
...
- (void)zfAutoLayoutView {
    ...
    [self.nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.trailing.mas_equalTo(self.followButton.mas_leading).offset(-10);
    }];
