...
- (void)followButtonAction:(UIButton *)sender {
    if (self.followUserCompletionHandler) {
        self.followUserCompletionHandler(self.model.user_id);
    }
}
...
- (void)setModel:(ZFCommunitySuggestedUsersModel *)model {
    ...
    if ([SystemConfigUtils isRightToLeftShow]) {
        ...
        self.beLikesLabel.text = [NSString stringWithFormat:@"%@ %@",model.likes_total,ZFLocalizedString(@"FriendsResultCell_BeLiked",nil)];
    } else {
        self.postsLabel.text = [NSString stringWithFormat:@"%@ %@",ZFLocalizedString(@"FriendsResultCell_Posts",nil),model.review_total];
        self.beLikesLabel.text = [NSString stringWithFormat:@"%@ %@",ZFLocalizedString(@"FriendsResultCell_BeLiked",nil),model.likes_total];
    }
