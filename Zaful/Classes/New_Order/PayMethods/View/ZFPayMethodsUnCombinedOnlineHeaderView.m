...
//
//  ZFPayMethodsUnCombinedOnlineHeaderView.m
//  Zaful
//
...
@interface ZFPayMethodsUnCombinedOnlineHeaderView() <ZFInitViewProtocol>
...
@implementation ZFPayMethodsUnCombinedOnlineHeaderView
...
- (void)tapAction {
    if (self.payMethodsOnlineSelectCompletionHandler) {
        self.payMethodsOnlineSelectCompletionHandler();
    }
}
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.text = ZFLocalizedString(@"ZFPaymentOnline", nil);
...
- (UILabel *)tipsLabel {
    if (!_tipsLabel) {
        ...
        _tipsLabel.text = ZFLocalizedString(@"ZFPaymentOnlineTip", nil);
